...
<body>
    ...
    <table id="empleados">
        ...
        <tbody>
            ...
            <div id="modalFormulario" class="modal">
                <div class="modal-content">
                    ...
                    <form id="formEmpleado" method="post">
                        ...
                        <button type="button" onclick="guardarOAnyadirEmpleado()">Guardar</button>
            ...
            try {
                $conexion = new PDO(
                    "mysql:host=host.docker.internal;dbname=employees",
                    "alumno",
                    "alumno"
                );
                ...
                $query = "SELECT emp_no, first_name, last_name, birth_date, hire_date, gender 
                        FROM employees
                        LIMIT 10";
